    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("license", models.CharField(blank=True, max_length=63)),
                ("iban", models.CharField(blank=True, max_length=34)),
                ("bic", models.CharField(blank=True, max_length=63)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "head",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, related_name="head", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name="users", to="club.membership"),
        ),
        migrations.AddField(
            model_name="user",
